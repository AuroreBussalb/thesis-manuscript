...
au sujet afin de l'aider à réguler son activité cérébrale \citep{Enriquez2017}. Cet entrainement s'effectue en cinq temps \citep{Enriquez2017}, détaillés
par la suite :
\begin{enumerate}
...
\noindent \textit{Acquisition du signal \gls{eeg}} \\
...
\noindent \textit{Pré-traitement du signal \gls{eeg}} \\
...
d'yeux et les artefacts musculaires ; les artefacts environnementaux sont le plus souvent dus aux lignes électriques (50Hz en Europe et 60Hz
aux Etats-Unis). 
...
incorrect le \textit{feedback} délivré \citep{Enriquez2017}. C'est pourquoi des méthodes de rejet ou de correction d'artefacts en temps 
réel sont implémentées.

Les méthodes de rejet consistent à ne pas extraire de marqueur d'intérêt dans une portion de l'\gls{eeg} (appelée époque). Pour sélectionner
...
Il est possible de corriger les artefacts oculaires en temps réel \citep{Barthelemy2017} 

Les artefacts dus aux artefacts électriques sont corrigés à l'aide d'un filtre coupe-bande.

\noindent \textit{Extraction du marqueur à moduler} \\
Ensuite, la troisième étape consiste à extraire le marqueur à moduler, appelé par la suite neuromarqueur : celui-ci, tout comme les électrodes utilisées, 
dépend de l'application du \gls{nfb}. Le neuromarqueur correspond le plus souvent aux ondes cérébrales listées en \ref{eeg_definition}, isolées au 
...
% bandes de fréquence, iapf, protocole plus adapté selon le profil

\noindent \textit{Génération du \textit{feedback}} \\
...
\noindent \textit{Auto-régulation de l'\gls{eeg} } \\
...
% déroulement des sessions de NFB : division par bloc
% bloc de transfert
