...
qui est au centre de ce travail, est présentée en détail, puis ses diverses applications sont listées. Dans la suite du manuscrit, seule l'une d'entre est étudiée : 
...
du cerveau pouvait être affecter par la modulation de l'\gls{eeg}. 

Peu de temps après, le Dr. Sterman a été approché par la NASA car les astronautes supportaient difficilement le carburant toxique, connu pour son risque de causer de violentes crises
d'épilepsie, utilisé pour les fusées. Afin d'évaluer sa toxicité et son effet épileptogène, ce carburant a été testé sur des chats parmi lesquels ceux qui avaient précédemment appris 
à moduler leur \gls{smr}. Comme attendu, au contact de ce carburant, les chats
ont souffert de convulsions, mais les chats ayant participer à l'expérience du \gls{smr} présentent moins de crises ou ont une meilleure tolérance aux effets du carburant \citep{Sterman1974}.  
Cette expérience a permis de démontrer que le contrôle de l'activité cérébrale pouvait être associé à des bénéfices cliniques, ouvrant ainsi la voie aux expériences sur les humains.
...
Alors que l'épilepsie est le premier champ d'application du \gls{nfb}, une autre application possible commence à être étudiée dans la foulée : le \gls{tdah} chez l'enfant \citet{Lubar1976}. 
Dans cette étude, les chercheurs vont  
...
% mieux décrire les évènements, utiliser thèse Pouch
...
% définition système 10-20, ce que signifient, C, P, ... nombres impairs à gauche (àvérifier)
