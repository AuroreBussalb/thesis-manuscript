...
Il exite différents types de \gls{bci} : les \gls{bci} dites actives et passives. Dans le premier cas, l'utilisateur essaye délibérément de contrôler son activité cérébrale afin
...
Alors que l'épilepsie a été la première application du \gls{nfb}-\gls{eeg}, un autre usage thérapeutique possible commence à être étudié dans la foulée : le \gls{tdah} chez l'enfant \citet{Lubar1976ADHD}. 
...
Les dates clés de l'histoire du \gls{nfb}-\gls{eeg} sont résumées à la frise présentée à la Figure~\ref{Figure:introduction_nfb_history}.
...
Enfin concernant le phénotype \gls{eeg} des enfants \gls{tdah}, \citet{Lubar1991} concluent que les enfants souffrant du \gls{tdah} présentent un excès 
