...
En plus des symptômes décrits plus haut, le \gls{tdah} impacte négativement le bien-être des enfants : ceux-ci ont une faible estime d'eux-mêmes \citep{Shaw2005} 
et ont de mauvais résultats scolaires \citep{Barry2002}. Ainsi, afin d'être pris en charge de façon adaptée, il est important de diagnostiquer le \gls{tdah} 
au plus tôt. 
...
Des marqueurs objectifs cérébraux obtenus grâce à l'\gls{eeg} ou par \gls{fmri} ne sont permettent pas d'améliorer le diagnostic pour un individu, mais
peuvent aider à distinguer différents groupes de patients \citep{Johnstone2005, Zhang2017, Clarke2011}. En effet, certains \gls{eeg} d'enfants \gls{tdah} 
...
\citep{Monastra2005, Janzen1995, Loo2018}. Un appareil ayant pour but d'aider le diagnostic du \gls{tdah} chez l'enfant en se basant sur leur \gls{eeg} 
...
Un traitement multimodal est recommandé pour le traitement du \gls{tdah} : il peut combiner différents traitements selon le besoin 
...
La performance du \gls{nfb} dans le traitement des signaux \gls{eeg} a fait l'objet de plusieurs études cliniques et de méta-analyses \citep{Sonuga-Barke2013,
Cortese2016, Micoulaud2014}. Dans ces études, l'efficacité du \gls{nfb} est évaluée à l'aide d'échelles cliniques telles que, par exemple, l'ADHD Rating Scale et 
la Conners qui sont des questionnaires à l'intention des parents, enseignants et médecins. 
...
la sévérité des symptômes : généralement, plus le score est haut, plus ils sont prononcés. Par ailleurs, certaines échelles permettent de calculer 
un score pour les composantes inattention, hyperactivité et symptômes totaux.

Les enseignants et les parents sont 
...
% groupes de comparaison : sham nfb
% dire où en est l'efficacité du nfb
