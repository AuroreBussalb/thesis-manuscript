...
appliquée aux enfants \gls{tdah} \citep{Arns2009, Maurizio2014, Strehl2017}. Dans le cas de l'analyse réalisée ici, lorsque l'\gls{es}-intra-groupe est négatif et plus sa valeur absolue est élevée, plus
...
\begin{figure}[h!]
  ...
  \caption[Arbre de décision]{Arbre de décision obtenu : \gls{es} correspond à l'\gls{es}-intra-groupe et $n$ au nombre d'études. L'importance des variables indépendantes
