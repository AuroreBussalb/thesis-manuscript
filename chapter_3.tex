...
\item \emph{la qualité de l'acquisition :} 
    ...
    Un score de qualité de 3 est donné si tous les critères ci-dessus sont remplis. Si au moins l'un d'eux est satisfait, le score est de 2, sinon il est mis à 1.
		\end{itemize}
Le matériel utilisé semble intuitivement être central quant à l'efficacité du \gls{nfb} d'où notre idée d'étudier son impact de plus près. En particulier,
...
de leur liste de bonnes pratiques. Ce point a également été souligné par \citet{Rogala2016} : les méthodologie suivies dans la recherche sur l'efficacité du
...
\citet{Vernon2004} suggèrent qu'au moins 20 sessions sont nécessaires pour observer un effet thérapeutique, 
ce qui a été confirmé par \citet{Arns2014, Wang2014} 
...
corrélation entre le nombre de sessions et les \gls{es}-inter-groupes calculés sur la composante inattention seulement. 
...
sur l'\gls{es}-inter-groupes calculé sur la composante totale d'une part sur les évaluations des parents et d'autre part sur celles des ensiagnants : 
...
Cette notion du nombre de sessions comprend plusieurs aspects comme le soulignent \citet{Strehl2014} parmi lesquels la durée du traitement et la fréquence des 
...
Par ailleurs, la durée du traitement est liée à son intensité : le \textit{paiplot} présenté à la Figure~\ref{factors_pairplot} montre que même si
...
\citet{Arnold2013} ne notent aucune différence d'amélioration thérapeutique entre les enfants effectuant 2 sessions par semaine
et ceux en effectuant 3. 

Les résultats de la \gls{saob} indiquent qu'adopter une fréquence élevée de sessions est préférable, ce qui est peu connu dans le domaine du \gls{nfb}. 
En effet sur la question de l'intensité du traitement, \citet{Strehl2014} s'appuie sur les résultats de l'entrainement cognitif d'enfants 
sains pour lesquels il a observé que des sessions dispersées conduisent à une meilleure efficacité \citep{Wang2014}. \citet{Enriquez2017} soulignent
également que dans le milieu de l'éducation, les leçons dispersées sont plus efficaces mais rappellent qu'en ce qui concerne le \gls{nfb},
trop peu d'éléments sont disponibles pour conclure quant au bénéfice de l'espacement des sessions.

Le type de protocole \gls{nfb} n'a été identifié par aucune méthode à l'exception de l'augmentation du rythme beta en central qui l'a été par une méthode. 
Ainsi, quel que serait le protocole d'entrainement, il n'influencerait pas l'efficacité du \gls{nfb}, son effet serait non-spécifique. Cette importance 
...
et donc sur l'impact sur l'efficacité thérapeutique \citep{Vernon2004}. Une probable 
...
Trois facteurs ont été identifiés par les trois méthodes avec, de plus, la même direction d'influence : la présence d'une phase de transfert, 
la durée du traitement, et les évaluateurs probablement aveugles au traitement. 
...
l'efficacité du \gls{nfb} : la qualité de l'\gls{eeg}
...
s'expliquer par le fait qu'un signal \gls{eeg} non contaminé par des artefacts permet d'extraire plus précisément les neuromarqueurs \citep{Barthelemy2019}. % à mieux discuter
...
protocoles d'entrainement basée sur l'\gls{iapf}. En effet, \citet{Vernon2004} et \citet{Klimesch1999} soulignent que les limites des bandes 
de fréquence varient d'individu à l'autre et sont aussi dépendantes de l'âge. Par ailleurs, les résultats paraissent prometteurs selon 
\citet{Bazanova2018} et \citet{Escolano2014}. Cependant, elle n'a pas pu être incluse dans la \gls{saob} faute d'un 
...
d'entrainement pourrait aussi être un facteur contribuant à l'efficacité du \gls{nfb}. Toutefois, dans son étude aucune différence significative 
n'est trouvée entre les résultats des performances à la clinique et à l'école. \citet{Vernon2004} avance qu'effectuer les séance de \gls{nfb} à l'école
...
Un paramètre central dans l'entrainement par \gls{nfb} a été exclu de la \gls{saob} faut d'un nombre suffisant d'études, il s'agit du type de seuillage 
grâce auquel les récompenses sont retournées au sujet.  

% paeler des types de feeback vernon2004, rogala2016
% threshold
