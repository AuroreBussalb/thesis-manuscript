...
de \gls{tbr} élevés comprenant seulement 5.79\% de la population. Ce faile pourcentage ainsi que la basse \gls{acc} obtenue laisse à penser
...
d'autres obtiennent des résultats plus négatifs. Une pssible explication de ce manque d'efficacité reporté dans ces études serait que contrôler 
un ratio de fréquence se revèle plus complexe que de moduler la puissance dans une simple bande de fréquence. 
