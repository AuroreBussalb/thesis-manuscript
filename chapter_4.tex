...
% donner une plus large définition en se basant sur la littérature
...
Afin de déterminer s'il existe un groupe d'enfants \gls{tdah} présentant un \gls{tbr} élevé, trois méthodes de partitionnement (\textit{clustering} en anglais), issues de familles différentes,
...
à 6 ans) et plus grands (18 à 21 ans) sujets. Cependant, faute d'un nombre suffisant d'informations dans ces extrêmes, cette étude ne peut pas être menée. Les prochaines
