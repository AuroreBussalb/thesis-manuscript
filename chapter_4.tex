...
grand \textit{cluster} comprenant l'ensemble des données \citep[Chapitre~10]{James2013}.
...
peut aider à choisir le nombre de \textit{clusters} à identifier \citep[Chapitre~10]{James2013}.
...
résultat serait que les artefacts oculaires présents dans la bande bêta seraient compensaient par ceux de la bande thêta. En effet, le \gls{tbr} est un ratio dont les bandes de
...
la bande thêta ne s'etend que sur 4Hz, contraitement à la bande bêta qui est plus longue (9Hz), ainsi l'hypothèse de la compensation paraît cohérente.
...
étant parfois plus jeunes de près d'un an, ils peuvent présenter un comportement différent qui peut amener à un diagnostic du \gls{tdah}. Evaluer si 
les deux \textit{clusters} d'enfants mis en évidence ici se distinguent par le mois de naissance serait intéressant.
...
En effet, le type de programme regardé par l'enfant aurait une infuence importante : les programmes éducatifs n'auraient pas effet d'effet négatif sur 
