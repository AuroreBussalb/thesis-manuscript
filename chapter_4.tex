...
\gls{tbr} \citep{Arns2013}, qui serait élevé chez les enfants souffrant du \gls{tdah} \citet{Lubar1991, Monastra1999, Barry2009, Snyder2006}. 
...
\item \emph{Cinquième étape :} les deux \textit{clusters} sont fusionnés pour en former un unique.
\end{enumerate}
...
Le nombre de \textit{clusters} estimé par cette méthode varie de 2 à 3 pour comparer les résultats obtenus à ceux du \gls{bgmm}. 
...
l'algorithme de propager les \textit{clusters}. A l'inverse, une trop grande valeur pour $\epsilon$  
...
que ces deux \textit{clusters} existent et sont correctement estimés par cette méthode, et c'est à partir de ces résultats que la capacité à discriminer les patients \gls{tdah} est évaluée.
