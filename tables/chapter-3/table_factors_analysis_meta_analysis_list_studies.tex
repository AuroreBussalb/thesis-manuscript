...
\midrule
 ...
 & & \shortstack{a = Réplication de \\ \citeauthor{Cortese2016}  \\ (voir \ref{replication}) } & 13 études & & 297 \\
\cmidrule(lr){3-6}
 ...
 & \shortstack{b = Mise à jour \\ \citeauthor{Cortese2016} \\ (voir \ref{selection_studies}) } & & 16 études & & 541 \\
\cmidrule(lr){2-6}
