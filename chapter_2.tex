...
% à détailler davantage, parler de l'approche bayésienne car on n'a peu d'échantillons 

\subsection{Hétérogénéité des études} 

Même si les méta-analyses regroupent les études répondant toutes aux critères d'inclusion comme, par exmple, ceux énoncés à \ref{selection_studies}, 
