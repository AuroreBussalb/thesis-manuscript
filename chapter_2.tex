...
des abscisses en haut de chaque graphique. Les $NSC$ sont obtenus de la façon suivante : $NSC(n) = NSC(n - 1) + NS(n)$, avec n, allant de 1 à N, l'indice de l'étude incluse.
...
\begin{figure}[h!]
  ...
  Les résultats de \citep{Cortese2016} sont représentés par des symboles rouges, ceux de \citet{Bussalb2016clinical} en vert et ceux présentés en \ref{selection_studies} en violet. Les étoiles 
	...
	Le nombre de sujets inclus par étude (NS) et cumulatif (NSC) est indiqué sur les axes des abscissses supérieurs et sont obtenus de la façon suivante : $\text{NSC}(n) = \text{NSC}(n - 1) + \text{NS}(n)$,
  avec $n$, allant de $1$ à $N$, l'indice de l'étude incluse.}
